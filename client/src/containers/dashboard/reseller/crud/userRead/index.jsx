...
const ResellerCRUDDashboard = () => {
  ...
  console.log("userId in user read Resller:", userId);
  ...
  return (
    <Box m={isMobile ? "1rem" : "1.5rem 2.5rem"}>
      <DashboardHeader 
        title="All Agencies" 
        subtitle="Information of all your Agencies" 
      />
...
export default ResellerCRUDDashboard;